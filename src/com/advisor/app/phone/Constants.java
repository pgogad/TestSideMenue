...
{
	public static String SHARED_PREF_NAME = "ADVISOR_APP";
	public static String EDITOR_PP_APPROVAL= "PP_APPROVAL";
	public static String EDITOR_EMAIL= "EMAIL_ADDRESS";
	public static String SAPERATOR = "~#@";
