...
public class GmailNavigation extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		mins = fileManagement.readFromFile();
		...
		buff.append("My readings are quick, honest and direct. At times, I can see far into timelines, up to 25 years down the road.")
				...
				.append("Personal Development/Career Development both at the Master Level. The aim in my sessions is for you to have full understanding and directness")
				...
				.append("I am genetically able to see into the future because of my acute ability of memory precision. Please understand that I am clairaudient HOWEVER,")
				.append("I do not utilize this in my sessions per choice. I am clairessient and can also tap into the multi-dimensions through a timeline grid I have learned")
				.append("to access. This is a very general overview of what is offered to you.")
				.append("Growth is a focus and lately my journey has allowed a new perspective into the way I read - clearer, more precise, dealing less and less on the superficial")
				.append("but more acutely into the root of the matter. What is frivilous is transient (though not without consequence), and I (we) will move beyond that.")
				.append("\n\n")
				...
				.append("my readings allowed for precise dates and time, however due to a personal transition and pathline shift, I have let go of time....and now give approx.")
				.append("as a guideline and do not probe deeper into being exact with dates .... I focus more on healing and soul shifts......my timing will be accurate but my")
				.append("focus is not on exact date precision as it was before. I can still do that but it takes alot of mental energy I now use for deeper soul healing segments.")
		...
		actionBarDrawerToggle = new ActionBarDrawerToggle(GmailNavigation.this, drawerLayout, R.drawable.ic_drawer, R.string.siane, R.string.app_name);
	...
	private class DrawerItemClickListener implements ListView.OnItemClickListener
	{
		...
		public void onItemClick(AdapterView parent, View view, int position, long id)
		{
			...
			{
				Intent intent = new Intent(getBaseContext(), PayPalActivity.class);
